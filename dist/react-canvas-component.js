	...
	var Component = function (_React$Component) {
	  ...
	  _createClass(Component, [{
	    ...
	    value: function render() {
	      ...
	      var context = this.context;
	      var draw = props.draw;
	      var realtime = props.realtime;
	      var top = props.top;
	      var left = props.left;

	      var other = _objectWithoutProperties(props, ['draw', 'realtime', 'top', 'left']);

	      requestAnimationFrame(this.requestAnimationFrameCallback);
	      if (context.ctx) {
	        return _react2.default.createElement(
	          'div',
	          _extends({ key: 'canvas' }, other),
	          props.children
	        );
	      }
	      return _react2.default.createElement(
	        'canvas',
	        _extends({ ref: 'canvas', key: 'canvas' }, other),
	        props.children
	      );
	    }
	  }, {
